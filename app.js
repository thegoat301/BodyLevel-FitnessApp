...
document.getElementById("createAccountBtn").onclick=()=>{
  ...
  users[username]={ xp:0, streak:0, history:[], records:{}, age, maxSessions, trainingLevel, dailySessions:{}, badges:[], challenge:{}, photos:[], lastWorkout:null };
  saveUsers(users);
  alert("Compte créé !");
...
document.getElementById("navProfile").onclick=()=>{
  ...
  document.querySelector("#profileModal .modal-content").prepend(h4);
...
/* ---------- AJOUTER PHOTO VIA CAMERA / IMPORT ---------- */
document.getElementById("addPhotoBtn").onclick = () => {
    let fileInput = document.createElement("input");
    fileInput.type = "file";
    fileInput.accept = "image/*";
    fileInput.capture = "environment"; // ouvre la caméra
    ...
    fileInput.onchange = () => {
        ...
        reader.onload = () => {
            ...
            saveUsers(users);
            // recharge le profil pour afficher la photo
