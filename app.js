...
document.getElementById("navProfile").onclick = () => {
  ...
  data.photos.forEach(p => { let img = document.createElement("img"); img.src = p; img.style.width = "80px"; img.style.height = "80px"; img.style.objectFit = "cover"; img.style.borderRadius = "8px"; photosDiv.appendChild(img); });
...
document.getElementById("navBadges").onclick = () => {
  ...
  Object.keys(BADGES).forEach(key => {
    ...
    switch (key) {
      case "motivated": cond = "Avoir une streak ≥ 3"; break;
